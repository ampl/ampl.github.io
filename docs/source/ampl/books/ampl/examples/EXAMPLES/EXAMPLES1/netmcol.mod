...
param cost {LINKS,PRODS} >= 0;      # shipment costs per ton
param capacity {LINKS,PRODS} >= 0;  # max tons shipped/product
param cap_joint {LINKS} >= 0;       # max total tons shipped/link
