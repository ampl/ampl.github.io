...
## 20260714
- Added keyword `license` to pass the license key from https://pages.cs.wisc.edu/~ferris/path/LICENSE
  without setting an environment variable


## 20250422
- Added new keywords (see `path -=` output)
- Synced driver source code with https://pages.cs.wisc.edu/~ferris/path.html


## 20230318
- Linked with Path 5.0.5


## 20050625
- Fixed a problem with the licensing routines on computers with many MAC addresses.
